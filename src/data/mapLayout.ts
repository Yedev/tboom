...
export const MAP_NODES: MapNode[] = [
  // ── Linear section 1-3 ───────────────────────────────────────────
  { id: '1',  level: 1,  x: 320, y: 840, isBoss: false, isSkip: false, label: '1',      next: ['2'] },
  { id: '2',  level: 2,  x: 320, y: 750, isBoss: false, isSkip: false, label: '2',      next: ['3'] },
  { id: '3',  level: 3,  x: 320, y: 660, isBoss: false, isSkip: false, label: '3',      next: ['4boss', '4skip'] },

  // ── First fork: BOSS 4 or skip to 5 ──────────────────────────────
  { id: '4boss', level: 4, x: 200, y: 560, isBoss: true,  isSkip: false, label: '4 BOSS', next: ['5'] },
  { id: '4skip', level: 5, x: 440, y: 560, isBoss: false, isSkip: true,  label: '跳过',   next: ['5'] },

  // ── Linear section 5-6 ───────────────────────────────────────────
  { id: '5',  level: 5,  x: 320, y: 460, isBoss: false, isSkip: false, label: '5',      next: ['6'] },
  { id: '6',  level: 6,  x: 320, y: 370, isBoss: false, isSkip: false, label: '6',      next: ['7boss', '7skip'] },

  // ── Second fork: BOSS 7 or skip to 8 ─────────────────────────────
  { id: '7boss', level: 7, x: 200, y: 270, isBoss: true,  isSkip: false, label: '7 BOSS', next: ['8'] },
  { id: '7skip', level: 8, x: 440, y: 270, isBoss: false, isSkip: true,  label: '跳过',   next: ['8'] },

  // ── Linear section 8-10 ──────────────────────────────────────────
  { id: '8',  level: 8,  x: 320, y: 170, isBoss: false, isSkip: false, label: '8',      next: ['9'] },
  { id: '9',  level: 9,  x: 320, y:  90, isBoss: false, isSkip: false, label: '9',      next: ['10'] },
  { id: '10', level: 10, x: 320, y:  20, isBoss: true,  isSkip: false, label: '10 BOSS',next: [] },
];
